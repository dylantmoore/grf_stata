* Test 15: Linear data - boosting shouldn't help much
adopath ++ /tmp/grf_stata
import delimited "/tmp/grf_stata/tests/fidelity_reports/10_boosted/test15_data.csv", clear
...
export delimited "/tmp/grf_stata/tests/fidelity_reports/10_boosted/test15_stata.csv", replace
