...
import delimited "/tmp/grf_stata/tests/fidelity_reports/05_quantile/test01_data.csv", clear
...
export delimited "/tmp/grf_stata/tests/fidelity_reports/05_quantile/test01_stata.csv", replace
