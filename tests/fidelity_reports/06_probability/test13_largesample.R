## Test 13: Large sample n=2000 (better calibration)
library(grf)
set.seed(42)
n <- 2000; p <- 5
...
write.csv(df, "/tmp/grf_stata/tests/fidelity_reports/06_probability/test13_data.csv", row.names = FALSE)
cat("Test13 LargeSample R done.\n")
cat("  n =", n, "\n")
